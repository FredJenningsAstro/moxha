...
if str(sys.argv[2]) == "highmass":
    redshift = 0.035
if str(sys.argv[2]) == "midmass" or str(sys.argv[2]) == "lowmass" :
    redshift = 0.01
...
instruments_dict = [ {"Name":"lem_2eV","ID":f"lem_2eV_1Ms_z{redshift}", "exp_time": (1000,'ks'), "reblock":1},]
...
for halo in halos:  
    ...
    obs.MakePhotons(metals = metals, photon_sample_exp=2000, area = (2.5, "m**2"), model = "IGM for Gerrit 18052023", make_profiles=False, make_phaseplots=False) 
